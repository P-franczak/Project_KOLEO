...
# Pociąg 13
lista_sasiedztwa_enum[Stacja.Katowice].append([Stacja.Katowice_Zawodzie, "45800", "06:00"])
lista_sasiedztwa_enum[Stacja.Katowice_Zawodzie].append([Stacja.Katowice_Szopienice_Południowe, "45800", "06:05"])
lista_sasiedztwa_enum[Stacja.Katowice_Szopienice_Południowe].append([Stacja.Mysłowice, "45800", "06:10"])
lista_sasiedztwa_enum[Stacja.Mysłowice].append([Stacja.Jaworzno_Szczakowa, "45800", "06:20"])
lista_sasiedztwa_enum[Stacja.Jaworzno_Szczakowa].append([Stacja.Balin, "45800", "06:30"])
...
# Pociąg 14
lista_sasiedztwa_enum[Stacja.Czechowice_Dziedzice].append([Stacja.Kaniów, "45900", "07:30"])
lista_sasiedztwa_enum[Stacja.Kaniów].append([Stacja.Dankowice, "45900", "16:35"])
lista_sasiedztwa_enum[Stacja.Dankowice].append([Stacja.Jawiszowice_Jaźnik, "45900", "07:40"])
lista_sasiedztwa_enum[Stacja.Jawiszowice_Jaźnik].append([Stacja.Brzeszce_Jawiszowice, "45900", "07:45"])
lista_sasiedztwa_enum[Stacja.Brzeszce_Jawiszowice].append([Stacja.Brzeszcze, "45900", "07:50"])
lista_sasiedztwa_enum[Stacja.Brzeszcze].append([Stacja.Oświęcim, "45900", "07:55"])
lista_sasiedztwa_enum[Stacja.Oświęcim].append([Stacja.Gorzów_Chrzanowski, "45900", "08:00"])
lista_sasiedztwa_enum[Stacja.Gorzów_Chrzanowski].append([Stacja.Chełmek, "45900", "08:05"])
...
# Pociąg 16
lista_sasiedztwa_enum[Stacja.Kraków_Główny].append([Stacja.Kraków_Łobzów, "46100", "05:15"])
lista_sasiedztwa_enum[Stacja.Kraków_Łobzów].append([Stacja.Kraków_Bronowice, "46100", "05:18"])
lista_sasiedztwa_enum[Stacja.Kraków_Bronowice].append([Stacja.Kraków_Mydlniki, "46100", "05:21"])
lista_sasiedztwa_enum[Stacja.Kraków_Mydlniki].append([Stacja.Kraków_Mydlniki_Wapiennik, "46100", "05:24"])
lista_sasiedztwa_enum[Stacja.Kraków_Mydlniki_Wapiennik].append([Stacja.Zabierzów_Rząska, "46100", "05:28"])
lista_sasiedztwa_enum[Stacja.Zabierzów_Rząska].append([Stacja.Zabierzów, "46100", "05:33"])
...
# Pociąg 18
lista_sasiedztwa_enum[Stacja.Oświęcim].append([Stacja.Gorzów_Chrzanowski, "46400", "04:00"])
lista_sasiedztwa_enum[Stacja.Gorzów_Chrzanowski].append([Stacja.Chełmek, "46400", "04:05"])
...
lista_sasiedztwa_enum[Stacja.Chrzanów].append([Stacja.Chrzanów_Śródmieście, "46400", "04:25"])
lista_sasiedztwa_enum[Stacja.Chrzanów_Śródmieście].append([Stacja.Trzebinia, "46400", "04:30"])
...
lista_sasiedztwa_enum[Stacja.Wola_Filipowska].append([Stacja.Krzeszowice, "46400", "04:50"])
...
lista_sasiedztwa_enum[Stacja.Zabierzów].append([Stacja.Zabierzów_Rząska, "46400", "05:05"])
lista_sasiedztwa_enum[Stacja.Zabierzów_Rząska].append([Stacja.Kraków_Mydlniki_Wapiennik, "46400", "05:10"])
lista_sasiedztwa_enum[Stacja.Kraków_Mydlniki_Wapiennik].append([Stacja.Kraków_Mydlniki, "46400", "05:15"])
lista_sasiedztwa_enum[Stacja.Kraków_Mydlniki].append([Stacja.Kraków_Bronowice, "46400", "05:20"])

# Pociąg 19
lista_sasiedztwa_enum[Stacja.Katowice].append([Stacja.Katowice_Zawodzie, "46500", "08:00"])
lista_sasiedztwa_enum[Stacja.Katowice_Zawodzie].append([Stacja.Katowice_Szopienice_Południowe, "46500", "08:05"])
lista_sasiedztwa_enum[Stacja.Katowice_Szopienice_Południowe].append([Stacja.Mysłowice, "46500", "08:10"])
lista_sasiedztwa_enum[Stacja.Mysłowice].append([Stacja.Jaworzno_Szczakowa, "46500", "08:20"])
lista_sasiedztwa_enum[Stacja.Jaworzno_Szczakowa].append([Stacja.Balin, "46500", "08:30"])
